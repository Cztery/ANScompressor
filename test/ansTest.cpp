...
TEST(reading_bitmaps3, check_red_image) {
  BmpImage myBmp;
  ...
  EXPECT_EQ(myBmp.fileHeader_.pixelDataOffset, sizeof(myBmp.fileHeader_) + sizeof(myBmp.infoHeader_));
  EXPECT_EQ(myBmp.fileHeader_.fileSize, sizeof(myBmp.fileHeader_) + sizeof(myBmp.infoHeader_) + myBmp.infoHeader_.dataSize);
  Image id(myBmp);
